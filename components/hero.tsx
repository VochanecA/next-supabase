...
// Lazy load framer-motion for non-blocking animations
...
// Simple grid pattern (inline SVG)
  ...
  return (
    <section className={`relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-24 md:py-32 ${inter.className}`}>
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Headings & Subheading - Static SSR content */}
        ...
        >
          {stats.map(({ value, label }) => (
            <MotionDiv key={label} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col items-center">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-white dark:from-gray-900 to-transparent" aria-hidden="true" role="presentation" />
    </section>
  );
};